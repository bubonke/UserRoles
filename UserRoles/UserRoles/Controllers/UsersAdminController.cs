...
namespace UserRoles.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Email,Id,FirstName,LastName,Gender,Phone")] RegisterViewModel userViewModel, params string[] selectedRoles)
        {
            ...
            var role = RoleManager.FindByName("Lab_Employee");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,FirstName,LastName,Gender,Phone")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
